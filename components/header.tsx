    ...
    >
      ...
      <div
        className={`transition-all duration-300 ease-in-out overflow-hidden ${
          isHovered ? "max-h-96 opacity-100 mt-6" : "max-h-0 opacity-0"
        }`}
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[var(--black-200)] rounded-lg p-4 hover:bg-[var(--black-300)] border border-[var(--blue-900)] transition-colors cursor-pointer">
            <div className="flex items-center gap-2 mb-3">
              {/* ...existing icon... */}
              <h3 className="text-lg font-bold text-[var(--blue-600)]">For Students</h3>
            </div>
            ...
            <ul className="text-[var(--text-primary)] text-xs space-y-1">
          ...
          <div className="bg-[var(--black-200)] rounded-lg p-4 hover:bg-[var(--black-300)] border border-[var(--blue-900)] transition-colors cursor-pointer">
            <div className="flex items-center gap-2 mb-3">
              {/* ...existing icon... */}
              <h3 className="text-lg font-bold text-[var(--blue-600)]">For Professionals</h3>
            </div>
            <p className="text-[var(--text-primary)] text-sm mb-2">
          ...
          <div className="bg-[var(--black-200)] rounded-lg p-4 hover:bg-[var(--black-300)] border border-[var(--blue-900)] transition-colors cursor-pointer">
            <div className="flex items-center gap-2 mb-3">
              {/* ...existing icon... */}
              <h3 className="text-lg font-bold text-[var(--blue-600)]">For Enterprise</h3>
            </div>
            <p className="text-[var(--text-primary)] text-sm mb-2">
